...
export default function Applications() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Application Delete Confirmation Dialog Modal */}
      <Dialog open={isDeleteOpen} onOpenChange={setIsDeleteOpen}>
        <DialogContent className="bg-white border border-stone-200 rounded-xl max-w-sm p-6 text-center text-stone-900">
          <div className="mx-auto flex h-12 w-12 items-center justify-center rounded-full bg-rose-50 text-rose-600 mb-4">
            <Trash2 className="h-6 w-6" />
          </div>
          <DialogHeader>
            <DialogTitle className="text-lg font-black text-stone-900">Delete Application?</DialogTitle>
          </DialogHeader>
          <div className="mt-2 text-sm text-stone-500">
            <p>
              Are you sure you want to permanently delete the application for <strong className="text-stone-900 font-bold">{selectedApp?.role}</strong> at <strong className="text-stone-900 font-bold">{selectedApp?.company?.companyName}</strong>?
            </p>
            <p className="text-xs text-rose-600 mt-2 font-medium">
              This action cannot be undone. All linked follow-ups, interview notes, and activity history for this application will be lost.
            </p>
          </div>
